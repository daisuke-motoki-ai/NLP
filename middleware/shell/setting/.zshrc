export MYVIMRCSUB=$HOME/setting_folder/
...
source ~/.zsh/peco-scripts/peco-select-history.zsh
source ~/zsh-vimode-visual/zsh-vimode-visual.zsh  # visual mode command の説明あり
